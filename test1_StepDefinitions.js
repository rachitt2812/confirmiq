...
When(
  "Update the {string} minimum notional limit to {string}",
  function (str1, str2) {
...
Given(
  "I launch url on {string} for CQCash, delivery method {string}",
  function (str1, str2) {
...
When(
  "I login with OLB Login details for FXC Desktop Health Check",
  function () {
    // Your test goes here ;
  },
);
...
When(
  "For health check, I select country and calculate currency exchange rate",
  function () {
    // Your test goes here ;
  },
);
...
When(
  "I choose the amount and the currency for the Order Foreign Currency",
  function () {
    // Your test goes here ;
  },
);
